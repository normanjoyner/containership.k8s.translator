...
function convert(mapping, conversion, source, initial) {
    initial = initial || {};
...
function csApplicationToK8SPodSpec(csAppDesc) { 
    return convert(CS_TO_K8S_POD_MAPPING, CS_TO_K8S_CONVERSIONS, csAppDesc, {});
}

function csApplicationToK8SReplicationController(csAppDesc) {
    const podSpec = csApplicationToK8SPodSpec(csAppDesc);

    return convert(CS_TO_K8S_RC_MAPPING, CS_TO_K8S_CONVERSIONS, csAppDesc, {
...
function csApplicationFromK8SPodSpec(k8sPodSpec) {
    return convert(CS_TO_K8S_POD_MAPPING, K8S_TO_CS_CONVERSIONS, k8sPodSpec, {});
}

function csHostFromK8SNode(k8sNode) {
    return convert(CS_TO_K8S_NODE_MAPPING, CS_TO_K8S_CONVERSIONS, k8sNode, {});
}
